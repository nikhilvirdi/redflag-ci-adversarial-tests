...
const newMcpServer_1 = require("../src/detectors/newMcpServer");
const swappedMcpServer_1 = require("../src/detectors/swappedMcpServer");
const widenedPermissions_1 = require("../src/detectors/widenedPermissions");
const hookChanged_1 = require("../src/detectors/hookChanged");
const monitoredFileDeleted_1 = require("../src/detectors/monitoredFileDeleted");
const unpinnedMcpDependency_1 = require("../src/detectors/unpinnedMcpDependency");
const obfuscatedCommand_1 = require("../src/detectors/obfuscatedCommand");
const duplicateJsonKey_1 = require("../src/detectors/duplicateJsonKey");
const suspiciousNetworkTarget_1 = require("../src/detectors/suspiciousNetworkTarget");
const pathTraversal_1 = require("../src/detectors/pathTraversal");
const transportTypeChange_1 = require("../src/detectors/transportTypeChange");
const invisibleUnicode_1 = require("../src/detectors/invisibleUnicode");
const homoglyphs_1 = require("../src/detectors/homoglyphs");
const ruleFileJsonKeys_1 = require("../src/detectors/ruleFileJsonKeys");
const aggregateFindings_1 = require("../src/aggregateFindings");
